        ...
        <table id="pagetable" class="table table-bordered bg-white text-dark text-center p-3 mt-4 shadow rounded-3 align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{
                                url('/assets/admin/images/admins/')
                            }}/{{ $user->photo }}" alt="Photo" width="50" />
                    </td>
                    <td>{{ $user->email }}</td>
                    <td>{{ $user->phone }}</td>
                ...
                <div class="modal fade" id="editModal{{ $user->staff_id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editModalLabel{{ $user->staff_id }}">
                                    Edit Admin
                                </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <form method="post" action="{{ url('/admin/edit') }}" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <span class="text-danger mt-2">@error('txtname')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <span class="text-danger mt-2">@error('txtemail')
                                            {{ $message }} @enderror</span>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <span class="text-danger mt-2">@error('txtphone')
                                            {{ $message }} @enderror</span>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="txtgender"
                                                id="genderMale{{ $user->staff_id }}" value="m" {{ $user->gender == 'm' ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="txtgender"
                                                id="genderFemale{{ $user->staff_id }}" value="f" {{ $user->gender == 'f' ?
                                            'checked' : '' }}>
                                            <label class="form-check-label"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="txtgender"
                                                id="genderOther{{ $user->staff_id }}" value="o" {{ $user->gender == 'o' ?
                                            'checked' : '' }}>
                                            <label class="form-check-label"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <img src="{{
                                                    url(
                                                        '/assets/admin/images/admins/'
                                                    )
                                                }}/{{ $user->photo }}" alt="Photo" width="150" />
                                        </div>
                                        <input type="file" class="form-control" id="txtphoto{{ $user->staff_id }}"
                                            name="txtphoto" />
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="txtisadmin"
                                            id="txtisadmin{{ $user->staff_id }}" value="1" {{ $user->isadmin ? 'checked' :
                                        '' }}>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="txtisfaculty"
                                            id="txtisfaculty{{ $user->staff_id }}" value="1" {{ $user->isfaculty ?
                                        'checked' : '' }}>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="txtisclubco"
                                            id="txtisclubco{{ $user->staff_id }}" value="1" {{ $user->isclubco ? 'checked'
                                        : '' }}>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="txtislibrarian"
                                            id="txtislibrarian{{ $user->staff_id }}" value="1" {{ $user->islibrarian ?
                                        'checked' : '' }}>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="txtisstaff"
                                            id="txtisstaff{{ $user->staff_id }}" value="1" {{ $user->isstaff ? 'checked' :
                                        '' }}>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="txtdesignation"
                                            id="txtdesignation{{ $user->staff_id }}" value="{{ $user->designation }}" />
                                        <span class="text-danger mt-2">@error('txtdesignation')
                                            {{ $message }} @enderror</span>
                                    </div>
                                    <div class="mb-3">
                                        <label for="txtexp_year{{ $user->staff_id }}" class="form-label">Experience
                                            Year</label>
                                        <input type="text" class="form-control" name="txtexp_year"
                                            id="txtexp_year{{ $user->staff_id }}" value="{{ $user->exp_year }}" />
                                        <span class="text-danger mt-2">@error('txtexp_year')
                                            {{ $message }} @enderror</span>
                                    </div>
                                </div>
                                <div class="modal-footer">
                ...
                <form method="post" action="{{ url('/admin/add') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="text-danger mt-2">@error('txtpass')
                                {{ $message }} @enderror</span>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Gender</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="txtgender" id="genderMale" value="m"
                                    checked />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="checkbox" class="form-check-input" name="txtislibrarian" id="txtislibrarian"
                                value="1" />
                        </div>
                        <div class="mb-3">
