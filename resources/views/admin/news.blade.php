                    ...
                    <form method="post" action="{{ url('/news/add') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="checkbox" class="form-check-input" name="txtstatus" id="txtstatus"
                                    value="1">
                            </div>
                    ...
                    <tbody>
                        @foreach ($news as $i => $notice)
                            <tr>
                                ...
                                <td>
                                    @if ($notice->report)
                                        <a href="{{ asset('assets/admin/news_reports/' . $notice->report) }}"
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#confirmDeleteModal{{ $notice->id }}">
                                            Delete
                                        </button>
                                    </div>
                                </td>
                            ...
                            <div class="modal fade" id="confirmDeleteModal{{ $notice->id }}" tabindex="-1"
                                aria-labelledby="confirmDeleteModalLabel{{ $notice->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="confirmDeleteModalLabel{{ $notice->id }}">Confirm
                                                Deletion</h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ url('/news/delete/' . $notice->id) }}"
                            ...
                            <div class="modal fade" id="editModal{{ $notice->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editModalLabel{{ $notice->id }}">Edit
                                                News/Notice</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="txttitle"
                                                        id="txttitle" value="{{ $notice->title }}">
                                                    <span class="text-danger mt-2">
                                                        @error('txttitle')
                                                            {{ $message }}
                                                        @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" name="txttype" id="txttype" required>
                                                        <option value="news"
                                                            {{ $notice->type == 'news' ? 'selected' : '' }}>News</option>
                                                        <option value="notice"
                                                            {{ $notice->type == 'notice' ? 'selected' : '' }}>Notice
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="txtreport" class="form-label">Report</label>
                                                    <input type="file" class="form-control" name="txtreport"
                                                        accept=".pdf, .doc, .docx" id="txtreport">
                                                    <input type="hidden" name="existing_report"
                                                        value="{{ $notice->report }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="txtstatus" class="form-label">Active</label>
                                                    <input type="checkbox" class="form-check-input" name="txtstatus"
                                                        id="txtstatus" value="1"
