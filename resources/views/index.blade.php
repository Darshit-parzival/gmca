...
<div id="visionMissionModal" class="modal">
    <div class="modal-content">
        ...
        <ul>
            ...
            <li>
                <p> To establish industry-academia interaction to facilitate the students to work proficiently in the industrial environment. To imbibe high moral values and professional ethics.</p>
            </li>
            <li>
                <p> To establish industry-academia interaction to facilitate the students to work proficiently in the industrial environment.</p>
            </li>
            <li>
